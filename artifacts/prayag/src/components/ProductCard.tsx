    ...
    <Link href={`/products/${product.slug}`} data-testid={`card-product-${product.id}`}>
      ...
      >
        <div className="relative aspect-square bg-white overflow-hidden">
          ...
          {product.imageUrl ? (
            <img src={product.imageUrl} alt={product.name} loading="lazy" className="relative w-full h-full object-contain group-hover:scale-105 transition-transform duration-500 ease-out" />
          ) : (
