    ...
    <Link href={`/products/${product.slug}`} data-testid={`card-product-${product.id}`}>
      ...
      >
        ...
        <div className="p-5 flex flex-col flex-1 relative z-10 bg-white">
          ...
          <div className="text-sm font-semibold text-gray-900 line-clamp-2 leading-relaxed mb-3 group-hover:text-[hsl(215,100%,34%)] transition-colors flex-1 font-serif-lux" data-testid={`text-name-${product.id}`}>
            {product.name}
          </div>
